...
CLIENTE_SEED: dict = {
    ...
    "fecha_inicio_explotacion": datetime(2026, 1, 15, tzinfo=UTC),
    "fecha_fin_mantenimiento": datetime(2028, 1, 14, tzinfo=UTC),
    "hitos": [
        {
            "nombre": "Puesta en producción de la plataforma",
            "fecha": "2026-01-15",
            "estado": "completado",
        },
        {
            "nombre": "Despliegue de tótems interactivos",
            "fecha": "2026-02-01",
            "estado": "completado",
        },
        {
            "nombre": "Chatbot multilingüe en producción",
            "fecha": "2026-02-15",
            "estado": "completado",
        },
