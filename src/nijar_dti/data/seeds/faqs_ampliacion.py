...
FAQS_AMPLIACION: list[dict] = [
    ...
    _faq("playa_cala_enmedio", "playas",
    ...
    _faq("playas_seguridad_medusas", "playas",
    ...
    # ===================== PARQUE NATURAL =====================
    _faq("parque_reserva_biosfera", "parque",
    ...
    _faq("parque_aves_flamencos", "parque",
    ...
    _faq("parque_faro_cabo_gata", "parque",
    ...
    _faq("parque_buceo_normativa", "parque",
    ...
    # ===================== RUTAS Y ACTIVIDADES =====================
    _faq("ruta_minera_rodalquilar", "rutas",
    ...
    _faq("actividad_kayak_snorkel", "rutas",
    ...
    _faq("actividad_bici_alquiler", "rutas",
    ...
    _faq("servicio_cajeros", "servicios",
        ...
        nivel="media"),
    _faq("servicio_farmacia", "servicios",
        ...
        nivel="media"),
    _faq("servicio_parking_san_jose", "servicios",
        ...
        nivel="media"),
    _faq("servicio_supermercado", "servicios",
    ...
    # ===================== GASTRONOMÍA =====================
    _faq("gastronomia_platos", "gastronomia",
    ...
    _faq("gastronomia_horarios", "gastronomia",
    ...
    _faq("gastronomia_vegetariano", "gastronomia",
        ...
        nivel="media"),
    _faq("gastronomia_vino", "gastronomia",
    ...
    # ===================== ALOJAMIENTO =====================
    _faq("alojamiento_tipos", "servicios",
    ...
    _faq("alojamiento_camping", "servicios",
        ...
        nivel="media"),
    _faq("alojamiento_temporada", "servicios",
    ...
    _faq("cultura_ceramica_nijar", "cultura",
    ...
    _faq("cultura_cortijo_fraile", "cultura",
        ...
        nivel="media"),
    _faq("cultura_cine_western", "cultura",
    ...
    _faq("cultura_mercadillo", "cultura",
    ...
    # ===================== EVENTOS =====================
    _faq("eventos_fiestas_san_jose", "eventos",
        ...
        nivel="media"),
    _faq("eventos_conciertos_verano", "eventos",
    ...
    # ===================== TRANSPORTE =====================
    _faq("transporte_aeropuerto", "servicios",
    ...
    _faq("transporte_distancias", "servicios",
    ...
    _faq("transporte_bus_lanzadera", "servicios",
    ...
    # ===================== ACCESIBILIDAD =====================
    _faq("accesibilidad_silla_anfibia", "accesibilidad",
    ...
    _faq("accesibilidad_perro_guia", "accesibilidad",
    ...
    _faq("accesibilidad_totem_bucle", "accesibilidad",
    ...
    _faq("practico_agua_potable", "general",
    ...
    _faq("practico_sostenibilidad", "parque",
    ...
    _faq("emergencia_incendio", "emergencias",
    ...
    _faq("emergencia_rescate_costa", "emergencias",
    ...
    _faq("emergencia_documentos_perdidos", "emergencias",
    ...
    # ===================== META / CHATBOT =====================
    _faq("meta_que_puedes_hacer", "general",
    ...
    _faq("meta_idiomas_chatbot", "general",
    ...
    _faq("meta_agradecimiento", "general",
        {"es": "¡Gracias!",
         "en": "Thank you!",
         "de": "Danke!",
         "fr": "Merci !"},
