...
FAQS_AMPLIACION_2: list[dict] = [
    # ---- Núcleos y enclaves ----
    _faq("nucleo_san_jose", "general",
        {"es": "¿Qué ofrece San José?", "en": "What does San José offer?",
         "de": "Was bietet San José?", "fr": "Que propose San José ?"},
    ...
    _faq("nucleo_isleta_moro", "general",
        {"es": "¿Cómo es La Isleta del Moro?", "en": "What is La Isleta del Moro like?",
         "de": "Wie ist La Isleta del Moro?", "fr": "Comment est La Isleta del Moro ?"},
    ...
    _faq("nucleo_los_escullos", "general",
        {"es": "¿Qué ver en Los Escullos?", "en": "What to see in Los Escullos?",
         "de": "Was gibt es in Los Escullos zu sehen?", "fr": "Que voir à Los Escullos ?"},
    ...
    _faq("nucleo_las_negras", "general",
        {"es": "¿Cómo es Las Negras?", "en": "What is Las Negras like?",
         "de": "Wie ist Las Negras?", "fr": "Comment est Las Negras ?"},
    ...
    _faq("enclave_arrecife_sirenas", "parque",
        {"es": "¿Qué es el Arrecife de las Sirenas?", "en": "What is the Arrecife de las Sirenas?",
         "de": "Was ist das Arrecife de las Sirenas?", "fr": "Qu'est-ce que l'Arrecife de las Sirenas ?"},
    ...
    _faq("enclave_mirador_amatista", "parque",
        {"es": "¿Merece la pena el Mirador de la Amatista?", "en": "Is the Amatista Viewpoint worth it?",
         "de": "Lohnt sich der Aussichtspunkt Amatista?", "fr": "Le belvédère de l'Amatista vaut-il le détour ?"},
    ...
    _faq("patrimonio_castillo_san_ramon", "cultura",
        {"es": "¿Se puede visitar el Castillo de San Ramón?", "en": "Can I visit San Ramón Castle?",
         "de": "Kann man die Burg San Ramón besichtigen?", "fr": "Peut-on visiter le château San Ramón ?"},
        ...
        nivel="media"),
    _faq("patrimonio_iglesia_nijar", "cultura",
        {"es": "¿Qué ver en el pueblo de Níjar?", "en": "What to see in Níjar town?",
         "de": "Was gibt es im Dorf Níjar zu sehen?", "fr": "Que voir au village de Níjar ?"},
    ...
    _faq("patrimonio_jardin_botanico", "cultura",
        {"es": "¿Qué es el Jardín Botánico El Albardinal?", "en": "What is the El Albardinal Botanical Garden?",
         "de": "Was ist der Botanische Garten El Albardinal?", "fr": "Qu'est-ce que le Jardin Botanique El Albardinal ?"},
    ...
    _faq("actividad_avistamiento_aves", "rutas",
        {"es": "¿Dónde observar aves además de en las salinas?", "en": "Where to watch birds besides the salt flats?",
         "de": "Wo Vögel beobachten außer an den Salinen?", "fr": "Où observer les oiseaux hormis aux salines ?"},
        ...
        nivel="media"),
    _faq("actividad_paseo_barco", "rutas",
        {"es": "¿Hay paseos en barco por las calas?", "en": "Are there boat trips along the coves?",
         "de": "Gibt es Bootsausflüge entlang der Buchten?", "fr": "Y a-t-il des sorties en bateau le long des criques ?"},
        ...
        nivel="media"),
    _faq("actividad_familias_ninos", "general",
        {"es": "¿Qué actividades hay para ir con niños?", "en": "What activities are there for children?",
         "de": "Welche Aktivitäten gibt es für Kinder?", "fr": "Quelles activités pour les enfants ?"},
    ...
    # ---- Servicios prácticos ----
    _faq("servicio_gasolinera", "servicios",
        {"es": "¿Dónde hay gasolineras?", "en": "Where are there petrol stations?",
         "de": "Wo gibt es Tankstellen?", "fr": "Où y a-t-il des stations-service ?"},
        ...
        nivel="media"),
    _faq("servicio_carga_electrico", "servicios",
        {"es": "¿Hay puntos de carga para coches eléctricos?", "en": "Are there EV charging points?",
         "de": "Gibt es Ladepunkte für Elektroautos?", "fr": "Y a-t-il des bornes de recharge électrique ?"},
        ...
        nivel="media"),
    _faq("servicio_alquiler_coche", "servicios",
        {"es": "¿Necesito coche para moverme por la zona?", "en": "Do I need a car to get around?",
         "de": "Brauche ich ein Auto, um herumzukommen?", "fr": "Ai-je besoin d'une voiture pour me déplacer ?"},
    ...
    _faq("servicio_veterinario", "servicios",
        {"es": "¿Hay veterinario por si viajo con mascota?", "en": "Is there a vet if I travel with a pet?",
         "de": "Gibt es einen Tierarzt, falls ich mit Haustier reise?", "fr": "Y a-t-il un vétérinaire si je voyage avec un animal ?"},
        ...
        nivel="media"),
    _faq("servicio_urgencias_turista", "servicios",
        {"es": "Soy turista extranjero, ¿cómo accedo a asistencia médica?", "en": "I'm a foreign tourist, how do I access medical care?",
         "de": "Ich bin ausländischer Tourist, wie bekomme ich medizinische Hilfe?", "fr": "Touriste étranger, comment accéder aux soins médicaux ?"},
    ...
    _faq("practico_pago_tarjeta", "general",
        {"es": "¿Se puede pagar con tarjeta en todas partes?", "en": "Can I pay by card everywhere?",
         "de": "Kann ich überall mit Karte zahlen?", "fr": "Peut-on payer par carte partout ?"},
        ...
        nivel="media"),
    _faq("practico_que_llevar", "general",
        {"es": "¿Qué debo llevar para visitar el parque?", "en": "What should I bring to visit the park?",
         "de": "Was sollte ich für den Parkbesuch mitnehmen?", "fr": "Que dois-je emporter pour visiter le parc ?"},
    ...
    _faq("practico_temporada_evitar", "general",
        {"es": "¿Cuándo hay menos gente?", "en": "When are there fewer people?",
         "de": "Wann ist weniger los?", "fr": "Quand y a-t-il moins de monde ?"},
    ...
    _faq("practico_mascotas_general", "general",
        {"es": "¿Puedo viajar con mi mascota por la zona?", "en": "Can I travel with my pet in the area?",
         "de": "Kann ich mit meinem Haustier in der Gegend reisen?", "fr": "Puis-je voyager avec mon animal dans la région ?"},
    ...
    # ---- Rutas adicionales ----
    _faq("ruta_san_pedro_pie", "rutas",
        {"es": "¿Cómo llego a la Cala de San Pedro?", "en": "How do I reach Cala de San Pedro?",
         "de": "Wie erreiche ich die Cala de San Pedro?", "fr": "Comment atteindre la Cala de San Pedro ?"},
    ...
    _faq("ruta_sendero_amoladeras", "rutas",
        {"es": "¿Hay senderos fáciles cerca del Centro de Visitantes?", "en": "Are there easy trails near the Visitor Center?",
         "de": "Gibt es leichte Wege beim Besucherzentrum?", "fr": "Y a-t-il des sentiers faciles près du Centre des Visiteurs ?"},
    ...
    _faq("eventos_mercado_pescado", "eventos",
        {"es": "¿Hay lonja o venta de pescado fresco?", "en": "Is there a fish market or fresh fish sale?",
         "de": "Gibt es einen Fischmarkt oder frischen Fischverkauf?", "fr": "Y a-t-il une criée ou vente de poisson frais ?"},
    ...
    _faq("meta_no_entiende", "general",
        {"es": "No me has entendido / ¿puedes repetir?", "en": "You didn't understand me / can you repeat?",
         "de": "Du hast mich nicht verstanden / kannst du wiederholen?", "fr": "Tu ne m'as pas compris / peux-tu répéter ?"},
    ...
    _faq("meta_hablar_persona", "general",
        {"es": "Quiero hablar con una persona de la oficina de turismo", "en": "I want to talk to a person at the tourist office",
         "de": "Ich möchte mit einer Person im Tourismusbüro sprechen", "fr": "Je veux parler à une personne de l'office de tourisme"},
    ...
    _faq("playa_servicios_chiringuito", "playas",
        {"es": "¿Las playas tienen chiringuitos y hamacas?", "en": "Do the beaches have beach bars and sunbeds?",
         "de": "Gibt es an den Stränden Strandbars und Liegen?", "fr": "Les plages ont-elles des paillotes et transats ?"},
    ...
    _faq("playa_bandera_azul", "playas",
        {"es": "¿Hay playas con bandera azul?", "en": "Are there Blue Flag beaches?",
         "de": "Gibt es Strände mit Blauer Flagge?", "fr": "Y a-t-il des plages pavillon bleu ?"},
    ...
    _faq("gastronomia_reservas", "gastronomia",
        {"es": "¿Necesito reservar mesa en los restaurantes?", "en": "Do I need to book a table at restaurants?",
         "de": "Muss ich im Restaurant einen Tisch reservieren?", "fr": "Dois-je réserver une table au restaurant ?"},
        ...
        nivel="media"),
    _faq("parque_fauna_camaleon", "parque",
        {"es": "¿Qué fauna puedo ver en el parque?", "en": "What wildlife can I see in the park?",
         "de": "Welche Tierwelt kann ich im Park sehen?", "fr": "Quelle faune puis-je voir dans le parc ?"},
    ...
    _faq("gastronomia_tapas", "gastronomia",
        {"es": "¿Hay cultura de tapas en la zona?", "en": "Is there a tapas culture in the area?",
         "de": "Gibt es eine Tapas-Kultur in der Gegend?", "fr": "Y a-t-il une culture des tapas dans la région ?"},
    ...
    _faq("servicio_correos", "servicios",
        {"es": "¿Dónde hay oficina de correos?", "en": "Where is there a post office?",
         "de": "Wo gibt es ein Postamt?", "fr": "Où y a-t-il un bureau de poste ?"},
        ...
        nivel="media"),
    _faq("transporte_estado_carreteras", "servicios",
        {"es": "¿Cómo son las carreteras dentro del parque?", "en": "What are the roads like inside the park?",
         "de": "Wie sind die Straßen im Park?", "fr": "Comment sont les routes dans le parc ?"},
        ...
        nivel="media"),
    _faq("alojamiento_precios_temporada", "servicios",
        {"es": "¿Varían mucho los precios de alojamiento según la época?", "en": "Do accommodation prices vary a lot by season?",
         "de": "Schwanken die Unterkunftspreise stark je Saison?", "fr": "Les prix d'hébergement varient-ils beaucoup selon la saison ?"},
