...
_LANG_MARKERS: dict[str, set[str]] = {
    "es": {
        "el","la","los","las","de","y","es","un","una","con","por","en","para",
        "que","más","muy","pero","cómo","dónde","están","está","aquí","está",
        "playa","ruta","fiesta","gracias","hola","mucho","mejor","todo",
    },
    "en": {
        "the","and","is","are","this","that","with","very","good","great","best",
        "amazing","beach","route","please","thanks","hello","you","we","they",
        "incredible","beautiful","love","worth",
    },
    "de": {
        "der","die","das","und","ist","sind","mit","sehr","gut","toll","schön",
        "strand","wanderung","danke","hallo","wir","ihr","sie","wirklich",
        "wahnsinn","wunderschön","besten",
    },
    "fr": {
        "le","la","les","et","est","sont","avec","très","bon","magnifique",
        "incroyable","plage","randonnée","merci","bonjour","nous","vous",
        "ils","elles","superbe","recommande",
    },
}
...
_POS: dict[str, set[str]] = {
    "es": {
        "bueno","buena","buenos","buenas","excelente","increíble","maravilloso",
        "espectacular","precioso","preciosa","fantástico","genial","mágico","mágica",
        "amable","limpio","tranquilo","recomiendo","recomendable","encanta","encantado",
        "encantada","perfecto","perfecta","único","única","top","mejor","ideal",
        "delicioso","cómodo","cómoda","feliz","disfrutar","divertido","divertida",
    },
    "en": {
        "good","great","excellent","amazing","wonderful","awesome","beautiful",
        "stunning","perfect","best","incredible","fantastic","love","loved",
        "lovely","worth","clean","calm","recommend","unforgettable","magical",
        "delicious","happy","enjoyed","fun","top","unique",
    },
    "de": {
        "gut","sehr","toll","wunderbar","wahnsinn","wahnsinnig","schön","schönste",
        "perfekt","beste","unglaublich","fantastisch","liebe","empfehlen","empfehlung",
        "magisch","sauber","ruhig","glücklich","genießen","top","einzigartig",
    },
    "fr": {
        "bon","bonne","excellent","excellente","superbe","magnifique","incroyable",
        "fantastique","parfait","parfaite","meilleur","meilleure","adore","adoré",
        "recommande","unique","propre","tranquille","heureux","heureuse","délicieux",
        "amusant","amusante",
    },
}
...
_NEG: dict[str, set[str]] = {
    "es": {
        "malo","mala","malos","malas","horrible","feo","fea","sucio","sucia",
        "decepción","decepcionante","peor","caro","cara","carísimo","ruidoso","ruidosa",
        "masificado","masificada","saturado","saturada","tarde","esperar","desastre",
        "estafa","aburrido","aburrida","problema","problemas","triste","frío","frías",
    },
    "en": {
        "bad","horrible","terrible","awful","worst","dirty","disappointed",
        "disappointing","expensive","crowded","overcrowded","noisy","disaster",
        "scam","boring","problem","problems","sad","cold","late","waste","ugly",
    },
    "de": {
        "schlecht","schlimm","furchtbar","schrecklich","dreckig","schmutzig",
        "enttäuscht","enttäuschend","teuer","überfüllt","laut","langweilig",
        "katastrophe","problem","traurig","kalt","spät","hässlich",
    },
    "fr": {
        "mauvais","mauvaise","horrible","terrible","sale","déçu","décevant",
        "cher","chère","bondé","bondée","bruyant","bruyante","ennuyeux","ennuyeuse",
        "désastre","arnaque","problème","triste","froid","froide","tard","laid",
    },
}
...
def analizar_sentimiento(texto: str, idioma: str | None = None) -> AnalisisSentimiento:
    ...
    if score >= 0.20:
        ...
        etiqueta = "neutro"
    return AnalisisSentimiento(etiqueta=etiqueta, score=round(score, 4), palabras_positivas=pos, palabras_negativas=neg)
...
_TEMAS: dict[str, set[str]] = {
    "playa": {
        "playa","playas","beach","beaches","strand","strände","plage","plages",
        "monsul","genoveses","playazo","cala","calas","arena","mar","sea","mer","meer",
    },
    "parque-natural": {
        "parque","cabo","gata","amoladeras","reserva","biosfera","unesco","ecosistema",
        "natural","park","biosphere","reservat","réserve","biosphère",
    },
    "ruta": {
        "ruta","rutas","sendero","senderismo","ciclismo","bici","bicicleta","mtb",
        "trail","hike","hiking","wandern","wanderung","randonnée","rodalquilar",
        "albaricoques","caminata",
    },
    "alojamiento": {
        "hotel","alojamiento","hostal","apartamento","camping","airbnb","casa","rural",
        "stay","stayed","accommodation","unterkunft","logement","cortijo",
    },
    "gastronomia": {
        "comida","comer","tapas","restaurante","gastronomia","gastronomía","pescado",
        "marisco","food","eat","seafood","essen","restaurant","manger","cuisine","menu",
    },
    "patrimonio": {
        "patrimonio","monumento","mina","minas","castillo","yacimiento","museo",
        "history","heritage","castle","mine","kulturerbe","schloss","mine","patrimoine",
    },
    "fotografia": {
        "foto","fotos","fotografia","fotografía","photo","photography","fotografieren",
        "fotografie","photographie","atardecer","amanecer","sunset","sunrise",
        "sonnenuntergang","coucher","instagram","instagrameable",
    },
    "accesibilidad": {
        "accesible","accesibilidad","silla","ruedas","accessible","wheelchair",
        "barrierefrei","accessibilité",
    },
    "masificacion": {
        "masificado","masificación","colas","aforo","crowded","crowd","overcrowded",
        "überfüllt","bondé","saturado",
    },
    "atardecer": {
        "atardecer","atardeceres","sunset","sonnenuntergang","coucher","crepusculo","crepúsculo",
    },
}
