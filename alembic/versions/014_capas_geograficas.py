...
Revision ID: 014_capas_geograficas
Revises: 013_metricas_publicidad
"""
...
revision: str = "014_capas_geograficas"
down_revision: Union[str, None] = "013_metricas_publicidad"
...
def upgrade() -> None:
    ...
    op.execute(
        "CREATE INDEX ix_elementos_geograficos_geom ON elementos_geograficos USING GIST(geometria)"
    )
